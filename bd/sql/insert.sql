...
-- Insertar personajes
INSERT INTO CHARACTERS (NAME, WEADPON, SWORD, SPEAR, AXE, BOW, MAGIC, Winged, Sprite, ATK, MOVEMENT, HEALTH) VALUES
...
-- Insertar ejércitos
INSERT INTO Army (USERID, CHARACTER1, CHARACTER2, CHARACTER3, CHARACTER4) VALUES
(1, 1, 2, 3, NULL),
(2, 2, 3, 4, NULL),
(3, 1, 3, 4, 2);

-- Actualizar ArmyID en USERS después de la inserción
UPDATE USERS SET ARMYID = 1 WHERE ID = 1;
UPDATE USERS SET ARMYID = 2 WHERE ID = 2;
UPDATE USERS SET ARMYID = 3 WHERE ID = 3;
